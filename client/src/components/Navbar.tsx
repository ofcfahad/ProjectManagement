...
const Navbar = ({ expand, menuTransitionDuration, handleLogout }) => {
    ...
    return (
        <motion.div initial={{ width: 0 }} animate={{ width: expand ? 300 : 100 }} transition={{ duration: menuTransitionDuration || 0.5 }} className={`bg-sidebarcolor h-full w-full font-josefin`}>
